export default {
  slug: "/blog/10-idees-pour-un-coin-photobooth-chic-au-mariage",
  seo: {
    title: "10 idées pour un coin photobooth chic au mariage | MirrorEffect",
    description:
      "Décor fleuri, fond texturé, potelets dorés… 10 idées élégantes et pratiques pour créer un coin photobooth chic et inoubliable le jour de votre mariage."
  },
  h1: "10 idées pour un coin photobooth chic au mariage",
  layout: "raw",
  leadMode: "b2c",
  rawHtml: `
    <div class="wrap">
      <header class="hero-article">
        <img src="https://mirroreffect.co/wp-content/uploads/2020/04/51d258c0-d87f-4276-b684-b5e5b16c33c8.jpg" alt="Coin photobooth chic au mariage" />
      ...
      <article class="prose">
        ...
        <h2>Checklist express (J-10 → J-0)</h2>
        <div class="callout">
          <ul>
            <li>Valider le <strong>cadre personnalisé</strong> (noms, date, teintes).</li>
            <li>Choisir le <strong>fond</strong> (fleurs, texture, mur existant).</li>
            <li>Prévoir <strong>prise électrique</strong> + <strong>espace 2,5 m × 2 m</strong>.</li>
        ...
        <p>Installation ~30 minutes, faible empreinte au sol, tirages 10×15 rapides, galerie privée J+1. Nous coordonnons avec votre salle et/ou wedding planner pour une mise en place sans friction.</p>
          ...
          <div class="related-list">
            <div class="callout">
              <a href="/blog/etude-de-cas-bourse/" style="text-decoration:none;color:inherit">
                <strong>MirrorEffect à la Bourse!</strong>
                <p class="note">Découvrez comment MirrorEffect a su créé une attraction à la Bourse avec le miroir.</p>
              </a>
            </div>
            <div class="callout">
