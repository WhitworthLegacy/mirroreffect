export default {
  slug: "/blog/combien-impressions-prevoir-10x15-vs-bandelettes",
  seo: {
    title: "Combien d'impressions prévoir : 10x15 vs bandelettes | MirrorEffect",
    description:
      "Découvrez nos repères simples pour estimer le nombre de tirages photobooth (10x15 ou bandelettes) à prévoir selon le nombre d'invités et la durée."
  },
  h1: "Combien d'impressions prévoir : 10×15 vs bandelettes",
  layout: "raw",
  leadMode: "b2c",
  rawHtml: `
    <div class="wrap">
      <header class="hero-article">
        <img src="https://mirroreffect.co/wp-content/uploads/2020/04/9cc68cb0-584f-4f49-a2b0-6b5cc73ee953.jpg" alt="Deux impressions photo 10x15 et bandelettes" />
      ...
      <article class="prose">
        ...
        <h3>Tableau d'estimation</h3>
        <table>
          <thead>
            <tr>
              <th>Nombre d'invités</th>
              <th>Estimation Basse (Tirages)</th>
              <th>Estimation Haute (Tirages)</th>
            </tr>
          </thead>
          <tbody>
            <tr><td>Moins de 80</td><td>300</td><td>500</td></tr>
            <tr><td>80 à 150</td><td>500</td><td>800</td></tr>
            <tr><td>150 à 250</td><td>800</td><td>1200</td></tr>
            <tr><td>Plus de 250</td><td>1200+</td><td>Illimité recommandé</td></tr>
          </tbody>
        </table>
        ...
        <ul>
          <li><strong>Qualité Visuelle Supérieure :</strong> La surface d'impression est quatre fois plus grande, ce qui met en valeur la qualité de l'image et du design.</li>
        ...
        <h2>Checklist express (Tirages)</h2>
        <div class="callout">
          <ul>
            <li>Définir la <strong>durée</strong> d'activation du photobooth.</li>
        ...
        <p>Oui, le forfait d'impression inclut toujours l'encre (ruban thermique) et le papier photo correspondant.</p>
        <h3>Puis-je changer d'avis sur le format ?</h3>
          ...
          <div class="related-list">
            <div class="callout">
              <a href="/blog/pourquoi-louer-un-photobooth-miroir-pour-son-mariage-avantages-conseils" style="text-decoration:none;color:inherit">
                <strong>Pourquoi louer un photobooth miroir pour son mariage ?</strong>
                <p class="note">Les avantages d’un miroir photo élégant pour des souvenirs inoubliables.</p>
              </a>
            </div>
            <div class="callout">
